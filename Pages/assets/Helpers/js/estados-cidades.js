...
function buscaCidades(e){
   ...
   if(j_index != -1){
      ...
      json_cidades.estados[j_index].cidades.forEach(function(estado){
         var est_opts = document.createElement('option');
         est_opts.setAttribute('value',estado)
         est_opts.innerHTML = estado;
         cidade_select.appendChild(est_opts);
      });
   }else{
      document.querySelector("#cidade").innerHTML = '';
   }
